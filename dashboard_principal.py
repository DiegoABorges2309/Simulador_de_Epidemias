...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, 
                             QVBoxLayout, QHBoxLayout, QPushButton, QStackedWidget, QLabel)
...
class DashboardPrincipal(QMainWindow):
    ...
    def construir_sidebar_lateral(self):
        ...
        ruta_mosquito  = os.path.join(dir_actual, "iconos", "mosquito1.png")  # <-- Corregido a .jpg
        ruta_play      = os.path.join(dir_actual, "iconos", "play.png")      # <-- Corregido a .jpg
    ...
    def construir_contenedor_central(self):
        ...
        self.vista_form = VistaFormulario(callback_iniciar=self.ejecutar_procesamiento_matematico)
        ...
        lbl_saludo.setStyleSheet("color: #00f0ff; line-height: 40px; letter-spacing: 1px;")
        
        lbl_instruccion = QLabel("Selecciona un icono en el panel lateral izquierdo para comenzar.")
    ...
    def ejecutar_procesamiento_matematico(self, config_humanos, config_vectores):
        ...
        self.vista_graficas.recibir_y_procesar_simulacion(config_humanos, config_vectores)
